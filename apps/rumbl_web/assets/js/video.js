...
let Video = {
    ...
    onReady(videoId, socket) {
        ...
        vidChannel.on("new_annotation", (resp) => {
            lastSeenId = resp.id;
            this.renderAnnotaion(msgContainer, resp);
        });
        ...
        vidChannel.join()
            .receive("ok",
                ...
                reason => console.log("join failed", reason));
    },
    ...
    renderAnnotaion(msgContainer, {user, body, at }) {
    ...
    renderAtTime(annotations, seconds, msgContainer){
        return annotations.filter( ann => {
            ...
            this.renderAnnotaion(msgContainer, ann);
            return false;
        });
    },
