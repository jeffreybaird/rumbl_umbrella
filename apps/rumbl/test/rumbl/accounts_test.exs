defmodule Rumbl.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "requires password be at least six characters" do
      attrs = Map.put(@valid_attrs, :password, "shrt")
      assert {:error, changeset} = Accounts.register_user(attrs)
  ...
  describe "authenticate_by_username_and_pass/2" do
    ...
    test "returns unauthorized user error with invalid password", %{user: user} do
